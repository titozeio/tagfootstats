          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  // Pass breakdown
                  _StatChip(label: 'PASE COM', value: stats.passesComplete),
                  _StatChip(label: 'PASE INC', value: stats.passesIncomplete),
                  _StatChip(label: 'PASE INT', value: stats.passesIntercepted),
                  ...
                  _StatChip(label: 'AVANCE MÁX', value: stats.maxAdvances),
                  _StatChip(label: 'FLAG FALL.', value: stats.missedFlags),
        ...
        child: ConstrainedBox(
          ...
          child: DataTable(
            ...
            columns: const [
              ...
              DataColumn(numeric: true, label: Text('COM')),
              DataColumn(numeric: true, label: Text('INC')),
              ...
              DataColumn(numeric: true, label: Text('AV.MX')),
              DataColumn(numeric: true, label: Text('F.FALL')),
              DataColumn(numeric: true, label: Text('INT DEF')),
            ...
            rows: playerStats.map((stats) {
              return DataRow(
                cells: [
                  ...
                  DataCell(Text('${stats.passesComplete}')),
                  DataCell(Text('${stats.passesIncomplete}')),
                  DataCell(Text('${stats.passesIntercepted}')),
                  ...
                  DataCell(Text('${stats.maxAdvances}')),
                  DataCell(Text('${stats.missedFlags}')),
